													...
													?>
														<form class="register-form" role="form" method="post">
															<div class="form-group">
																...
																<input type="text" class="form-control unicase-form-control text-input" id="shippingaddress" name=" shippingaddress" value="<?php echo $row['shippingAddress']; ?>" required>
															</div>
															<div class="form-group">
